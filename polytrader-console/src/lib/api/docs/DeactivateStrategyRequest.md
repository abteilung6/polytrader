...
------------ | ------------- | ------------- | -------------
**reason** | **string** | Reason for deactivation | [default to undefined]
...
```typescript
import { DeactivateStrategyRequest } from '@polytrader/api-client';

const instance: DeactivateStrategyRequest = {
    reason,
    issued_by,
    client_request_id,
};
