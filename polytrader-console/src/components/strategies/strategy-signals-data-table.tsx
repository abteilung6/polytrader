...
interface StrategySignalsDataTableProps {
  columns: ColumnDef<StrategySignalItem>[]
  data: StrategySignalItem[]
}

export function StrategySignalsDataTable({ columns, data }: StrategySignalsDataTableProps) {
