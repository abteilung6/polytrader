...
interface StrategyOrdersDataTableProps {
  columns: ColumnDef<StrategyOrderItem>[]
  data: StrategyOrderItem[]
}

export function StrategyOrdersDataTable({ columns, data }: StrategyOrdersDataTableProps) {
